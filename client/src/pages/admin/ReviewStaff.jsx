                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">Dept Id</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {filteredStaff.map((staff) => (
                                            <tr key={staff.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{staff.staffCode}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{staff.departmentCode}</td>
